(function(root) {
    ...
    Protected.prototype = {
        ...
        layout: function() {
            ...
            if (typeof this.height == 'undefined') this.height = (this.rows.length * this.settings.card.size) + (2 * this.settings.card.size) + (this.rows.length * this.settings.card.space) + this.settings.card.space + (this.settings.graph.font.size + 4);

            this.canvas.height = this.height;

            var container = document.getElementsByClassName("slyck-schedule-ui")[0];
            ...
            var endRight = document.getElementsByClassName("end-right")[0];
            ...
            var endLeft = document.getElementsByClassName("end-left")[0];
...
var data = [{
    name: 'Ray',
    startTime: '1479837924', //1800 Local
    endTime: '1479845124' // 2000 Local
}, {
    name: 'Bob',
    startTime: '1479794724', //0600 Local
    endTime: '1479816324', //1200 GMT
}, {
    name: 'Bill',
    startTime: '1479794724', //0600 Local
    endTime: '1479805524' //0900 Local
}, {
    name: 'Steve',
    startTime: '1479794724', //0600 Local
    endTime: '1479845124' // 2000 Local
...
var scehdule = new SlyckSchedule(data, {
    data: {
        label: 'name',
        time: {
            start: 'startTime',
